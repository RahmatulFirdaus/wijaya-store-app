...
class DetailProdukPenjualanOffline extends StatefulWidget {
  final String productId;
  const DetailProdukPenjualanOffline({super.key, required this.productId});

  @override
  State<DetailProdukPenjualanOffline> createState() =>
      _DetailProdukPenjualanOfflineState();
}

class _DetailProdukPenjualanOfflineState
    extends State<DetailProdukPenjualanOffline> {
  ...
  Future<void> handleAddToCart() async {
    ...
    try {
      ...
      // Call API to send the offline sale
      final result = await PostKaryawanPenjualanOffline.kirimPenjualan(
        idVarianProduk: selectedVariant.idVarian.toString(),
